...
def session(kind):
    ...
    expected = APP / "usr/lib/Nelomai/runtime/engines/latest/0.2.19/nelomai-runtime"
    with subprocess.Popen([str(common)]) as child:
        try:
            ...
            source_engine = APP / "usr/lib/Nelomai/runtime/engines/latest/0.2.19/nelomai-unix-service"
