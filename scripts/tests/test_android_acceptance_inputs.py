...
from scripts.tests.test_android_runtime_collisions import NDK, JAVAC
...
class AndroidAcceptanceInputsTest(unittest.TestCase):
    def test_latest_inputs_use_compiled_identity_and_exact_staged_archive(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            manifest = dict(format_version=1, runtime_version="0.2.16", source_commit=SOURCE,
            ...
            self.assertEqual(result["runtime_version"], "0.2.17-acceptance")
