...
export const CHANGELOG = defineChangelog([
  ...
  {
    version: "0.2.18",
    items: ["Исправлено зависание подготовки приложения после обновления при истечении сессии. Восстановление выполняется без повторного входа."],
  },
  {
    version: "0.2.17",
    items: ["Технический апдейт"],
  },
  {
    version: "0.2.16",
    items: [
